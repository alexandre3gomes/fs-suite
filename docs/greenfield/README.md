...
| [google-oauth.md](google-oauth.md) | OAuth 2.0 client + consent screen (GCP console)              | `GOOGLE_CLIENT_ID`, `GOOGLE_CLIENT_SECRET` |
...
2. **Supabase** (DB connection string needed by the API)
