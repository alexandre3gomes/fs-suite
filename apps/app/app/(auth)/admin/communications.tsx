...
import { Button, Card, CardContent, Input, Spinner, Text } from '@fs-suite/ui';
...
const DROPDOWN_STYLES = StyleSheet.create({
  ...
  selectedText: { fontSize: 14, color: '#1a1d26' },
  placeholder: { fontSize: 14, color: '#9ca3af' },
  itemText: { fontSize: 14, color: '#1a1d26' },
  container: { borderRadius: 8, borderColor: '#e5e7eb', overflow: 'hidden' },
});
          ...
          <CardContent className="gap-4 md:px-6 md:py-6">
            <View>
              ...
              <Dropdown
                ...
                disable={isSent}
                style={DROPDOWN_STYLES.field}
                selectedTextStyle={DROPDOWN_STYLES.selectedText}
                placeholderStyle={DROPDOWN_STYLES.placeholder}
                containerStyle={DROPDOWN_STYLES.container}
                itemTextStyle={DROPDOWN_STYLES.itemText}
                activeColor="#eef2ff"
                maxHeight={240}
              />
            </View>
